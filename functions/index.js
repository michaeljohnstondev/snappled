...
exports.createGlobalGift = require('./gifts').createGlobalGift;
exports.claimGifts = require('./gifts').claimGifts;
exports.onCommentCreated = require('./comments').onCommentCreated;
exports.onSnappleReported = require('./snappleModeration').onSnappleReported;
exports.onSnappleLikesChanged = require('./snappleStats').onSnappleLikesChanged;
